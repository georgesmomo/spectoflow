...
// lib/store.js, plus the main lib/adapters.js and lib/detect.js) and drops its cached Map entry.
// The require cache keys by absolute path, so this can never touch another project's identically-named
// files. Returns false
