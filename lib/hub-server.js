...
// lib/store.js). The require cache keys by absolute path, so this can never touch another project's
// identically-named files. Returns false (a harmless no-op, not an error) if this id was never loaded
