...
(function (root) {
  ...
  const ICON = {
    ...
    // calendar page — Daily meeting (a dated entry, not a generic list like backlog)
    meeting: wrap('<rect x="2.6" y="4" width="12.8" height="11" rx="1.4"/><line x1="2.6" y1="7.4" x2="15.4" y2="7.4"/><line x1="5.6" y1="2.6" x2="5.6" y2="5.2"/><line x1="12.4" y1="2.6" x2="12.4" y2="5.2"/><line x1="5.4" y1="10.2" x2="7.6" y2="10.2"/>'),
  };
