...
// The 12 native nav tab ids (Sous-projet C: Task 1 built the mechanism with the original 11; Task 2
// registers 'notes' — the Bloc note scratchpad — into it; a future Daily meeting task adds its own),
// mirroring app.js's ROUTES array exactly — the one server-side source of truth for "what's a real
// native tab id".
