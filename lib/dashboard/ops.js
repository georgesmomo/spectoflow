...
// The 11 native nav tab ids (Sous-projet C, Task 1), mirroring app.js's ROUTES array exactly — the
// one server-side source of truth for "what's a real native tab id". Future tasks (Bloc note, Daily
// meeting) register their own id into this same list; this task only builds the mechanism.
