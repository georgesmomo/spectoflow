...
Palette: research · analysis · architecture · planning · testing · implementation · security · quality · design.

| Project type | Active capabilities |
|---|---|
| app / web / API | all |
| infra / IaC | research, analysis, architecture, planning, security, quality, implementation |
| data / ETL | analysis, architecture, planning, testing (data quality), implementation, quality |
| study / content | research, analysis, planning, quality |
